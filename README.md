...
For example, the `logs` table containing all the sessionized and enriched logs is used as to power the other tables:
...
Please see the Bonus section below for a more detailed functional explanation.
